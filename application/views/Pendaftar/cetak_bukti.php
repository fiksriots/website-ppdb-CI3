...
foreach($data_diri as $tr){
	  ...
	  $pdf = new FPDF('P','mm','A4');
            ...
            $pdf->Cell(2,5,': ',0,0,'L');
            $pdf->Cell(300,5,$tr->nama_lengkap,0,1,'L');
            $pdf->Cell(70,5,'   02. NIK',0,0,'L');
            $pdf->Cell(2,5,': ',0,0,'L');
            $pdf->Cell(300,5,$tr->nik,0,1,'L');
            $pdf->Cell(70,5,'   03. Jenis Kelamin',0,0,'L');
            $pdf->Cell(2,5,': ',0,0,'L');
            $pdf->Cell(300,5,$tr->gender,0,1,'L');
            ...
            $pdf->Cell(2,5,': ',0,0,'L');
            $pdf->Cell(45,5,$tr->tempat_lahir.','.tanggal_indo($tr->tgl_lahir),0,1,'L');
            $pdf->Cell(70,5,'   05. Yatim/piatu/yatim piatu',0,0,'L');
            $pdf->Cell(2,5,': ',0,0,'L');
            $pdf->Cell(300,5,$tr->status_anak,0,1,'L');
            $pdf->Cell(70,5,'   06. Domisili',0,0,'L');
            $pdf->Cell(2,5,': ',0,0,'L');
            $pdf->Cell(300,5,$tr->alamat,0,1,'L');
            $pdf->Cell(300,5,'',0,1,'L');
            $pdf->SetFont('Times','B',12);
            ...
            $pdf->Cell(45,5,$tr->nama_ayah,0,0,'L');
            $pdf->Cell(25,5,' Ibu      :',0,0,'L');
            $pdf->Cell(45,5,$tr->nama_ibu,0,1,'L');
            $pdf->Cell(70,5,'   02. Pendidikan Orang Tua',0,0,'L');
            $pdf->Cell(25,5,': Ayah    : ',0,0,'L');
            $pdf->Cell(45,5,$tr->pendidikan_ayah,0,0,'L');
            $pdf->Cell(25,5,' Ibu      :',0,0,'L');
            $pdf->Cell(45,5,$tr->pendidikan_ibu,0,1,'L');
            $pdf->Cell(70,5,'   03. Pekerjaan Orang Tua',0,0,'L');
            $pdf->Cell(25,5,': Ayah    : ',0,0,'L');
            $pdf->Cell(45,5,$tr->pekerjaan_ayah,0,0,'L');
            $pdf->Cell(25,5,' Ibu      :',0,0,'L');
            $pdf->Cell(45,5,$tr->pekerjaan_ibu,0,1,'L');
            $pdf->Cell(70,5,'   04. Penghasilan Orang Tua',0,0,'L');
            $pdf->Cell(10,5,': ',0,0,'L');
            $penghasilanortu = $tr->penghasilan_ayah+$tr->penghasilan_ibu;
            $pdf->Cell(300,5,$penghasilanortu,0,1,'L');
            $pdf->Cell(70,5,'   05. Alamat Orang Tua',0,0,'L');
            $pdf->Cell(10,5,': ',0,0,'L');
            $pdf->Cell(100,5,$tr->alamat_ayah,0,1,'L');
            $pdf->Cell(300,5,'',0,1,'L');
            $pdf->SetFont('Times','B',12);
            ...
            $pdf->Cell(2,5,': ',0,0,'L');
            $pdf->Cell(300,5,$tr->asal_sekolah,0,1,'L');
            $pdf->Cell(300,5,'',0,1,'L');
            $pdf->SetFont('Times','B',12);
            ...
            $pdf->Cell(70,5,$tr->nama_lengkap,0,1,'L');	
