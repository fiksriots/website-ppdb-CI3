                      ...
                      <div class="col-md-6 justify-content-center">
                            ...
                            <?php } 
                             elseif(empty($id) && isset($st)) { ?>
                                ...
                                <a href="<?php echo base_url('pendaftar/form_pendaftaran/tambah_data')?>" class="btn  btn-success mr-6 mb-3 ">Isi Formulir</a>
                            <?php } else{?>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="" class="btn  btn-danger mr-6 mb-3 disabled">Anda Sudah Mengisi Formulir</a>
                                    <a href="<?php echo base_url('pendaftar/laporanpdf')?>" class="btn  btn-danger mr-6 mb-3 ">Download Formulir</a>
                                 </div>
                                <div class="btn-group ml-3" role="group" aria-label="Third group">
                                    <a href="<?php echo base_url('pendaftar/form_pendaftaran/update_data')?>" class="btn  btn-warning mr-6 mb-3 ">Ubah Data</a>
                                </div>
                            <?php }?>
